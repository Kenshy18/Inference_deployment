...
import { buildMonitorFlow } from "./monitor/flow";
import type { MonitorQueueInfo } from "./monitor/flow";
...
export type QueueInfo = MonitorQueueInfo;
...
export function MonitorPanel({
  ...
  const { nodes, overlayCount } = buildMonitorFlow(draft, job, queueInfo);
