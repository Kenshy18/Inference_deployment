...
PROFILE_ID = "production_polygon_adaptive14_20_cpu_exact_v1"
...
class ProductionConfig:
    ...
    require_zero_exact_recall_violations: bool = True
    ...
    def validate(self) -> None:
        ...
        if self.vertices_per_component != 14:
            raise ValueError("Production minimum vertex count must be 14")
        if self.vertex_fallbacks != (14, 16, 18, 20):
            raise ValueError("Production vertex fallbacks must be 14,16,18,20")
