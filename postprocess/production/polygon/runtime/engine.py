"""Stable subprocess boundary for the parity-frozen Production optimizer."""
...
from .spatial_config import CANDIDATE as APPROVED_POLYGON_CONTRACT
...
def assert_runtime_bridge_contract(
    ...
    """Fail closed if the internal optimizer no longer matches this profile."""
    config.validate()
...
def run_polygon_optimizer(
    ...
    *,
    ...
    command = [
        sys.executable,
        "-m",
        "production.polygon.runtime.run",
        "--source-root",
