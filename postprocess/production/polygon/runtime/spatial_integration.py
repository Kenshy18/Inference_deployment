...
from .spatial_support.placement import rdp_fixed_count
from .spatial_support.optimizer import (
    _best_phase,
    has_self_intersection,
)

from .spatial_config import CANDIDATE, Polygon14CandidateConfig
from .spatial_builder import build_spatial_track
...
def apply_spatial_candidate(
    ...
    from .spatial_config import ALLOWED_ADAPTIVE_VERTICES
