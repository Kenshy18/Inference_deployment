"""Offline builders for the RTX 5090 fixed-B2 Co-DINO TensorRT group."""
...
EXPECTED_PROTECTED = {"query_encoder": 18}
EXPECTED_PLUGIN_NODES = {"query_encoder": 6, "decoder": 6}
MAX_AUX_STREAMS = {
    "backbone": 0,
    "query_encoder": 2,
    "decoder": 2,
...
def _build_engine(
    ...
    if component == "query_encoder":
        _require(len(plugin_layers) == 6, "serialized SM120 plugin-layer drift")
    return {
        "component": component,
        "elapsed_seconds": elapsed,
